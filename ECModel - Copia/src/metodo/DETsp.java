...
public class DETsp implements Metodo {
    ...
    public Individuo executar() {
        ...
        // Converter - representacao eral para inteiro
    ...
    public void converteRealParaInteiro(PopulacaoDouble populacao, PopulacaoInteger popTSP) {
    	popTSP.getIndividuos().clear();
    	
    	for (Individuo ind : populacao.getIndividuos()) {
    		IndividuoInteger indTSp = this.converteRealParaInteiro(ind);
...
//    	
    	...
    	Individuo copiaValores = (IndividuoDouble) individuo.clone();
